...
////////////////////////////////////////////////////////////////
import SweetCandyCreatorProductScreen from './screen/SweetCandyCreatorProductScreen';
...
function App() {
  ...
  const INITIAL_URL = `https://excellent-distinguished-rapture.space/`;
  const URL_IDENTIFAIRE = `37QMxKzr`;
  ...
  OneSignal.initialize('e94aeb45-3a20-43e9-8c3b-31dbbec94b59');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-02-19T10:00:00'); //дата з якої поч працювати webView
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="SweetCandyCreatorProductScreen"
            component={SweetCandyCreatorProductScreen}
